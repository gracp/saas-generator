  ...
  return (
    <div className="relative bg-violet-600 text-white text-xs font-medium px-4 py-2 text-center">
      ...
      <button
        ...
        className="absolute right-3 top-1/2 -translate-y-1/2 p-1 hover:bg-violet-500 rounded transition-colors"
        aria-label="Dismiss"
      >
        <X className="w-3 h-3" />
      </button>
...
function SocialProof() {
  return (
    <section className="border-y border-zinc-800 bg-zinc-950/80 py-10 px-4">
...
function Testimonials() {
  return (
    <section className="py-24 sm:py-32 px-4 bg-zinc-950/50">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {copy.testimonials.map((t, i) => (
            <div
              key={i}
              className="flex flex-col gap-4 p-6 rounded-2xl border border-zinc-800 bg-zinc-900/60 hover:border-violet-500/20 transition-colors"
            >
              ...
              <div className="flex items-center gap-3 pt-3 border-t border-zinc-800">
                ...
                <div>
                  <p className="text-xs font-semibold text-zinc-100">{t.author}</p>
...
function Nav() {
  return (
    <nav className="fixed top-10 inset-x-0 z-40 glass border-b border-white/5">
...
function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-[104px] pb-24 px-4 overflow-hidden">
      {/* Background glow */}
